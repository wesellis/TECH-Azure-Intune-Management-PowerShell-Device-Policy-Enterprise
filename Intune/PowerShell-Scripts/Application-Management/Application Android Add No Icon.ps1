<#
.SYNOPSIS
    Application Android Add No Icon
...
<#
.SYNOPSIS
    We Enhanced Application Android Add No Icon
...
$WECreate_Outlook = Add-AndroidApplication -JSON $WEOutlook
...
; 
$WECreate_Browser = Add-AndroidApplication -JSON $WEBrowser
...
; 
$WECreate_Excel = Add-AndroidApplication -JSON $WEExcel
