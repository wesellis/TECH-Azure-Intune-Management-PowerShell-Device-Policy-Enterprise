...
$WEApp_resource = " deviceAppManagement/mobileApps"
    ...
    try {
        ...
        write-verbose " Icon specified: $WEIconURL"
            ...
            Write-Information " Icon Path '$WEIconURL' doesn't exist..."
...
Write-Information " Publishing" ($WEOutlook | ConvertFrom-Json).displayName -ForegroundColor Yellow
...
Write-Information Write-Information " Publishing" ($WEBrowser | ConvertFrom-Json).displayName
; 
...
Write-Information Write-Information " Publishing" ($WEExcel | ConvertFrom-Json).displayName
; 
