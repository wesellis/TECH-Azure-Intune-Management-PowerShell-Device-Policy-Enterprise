...
<#
.SYNOPSIS
    We Enhanced Application Category Add
...
.EXAMPLE
Add-ApplicationCategory -AppCategoryName $WEAppCategoryName
...
$WEResource = " deviceAppManagement/mobileAppCategories"
    ...
    try {
        ...
        if(!$WEAppCategoryName){

        Write-Information " No Application Category Name specified, specify a valid Application Category Name" -f Red
        break
...
; 
$WECategory = Add-ApplicationCategory -AppCategoryName " LOB Apps 2"

Write-WELog " Application category added" " INFO" $WECategory.displayname " with ID" $WECategory.id -ForegroundColor Green
