...
; 
$WEIntune_Apps = Get-IntuneApplication -ErrorAction Stop | Select-Object displayName,id,'@odata.type'

$WEIntune_Apps | ForEach-Object {

Write-Information $_.displayName -ForegroundColor Yellow
Write-Information $_.id
Write-Information $_.'@odata.type'
; 
$WEApp_Assignment = Get-ApplicationAssignment -ApplicationId $_.id
    ...
    Write-WELog " Application Assigned" " INFO" -ForegroundColor Green
        ...
        Write-Information " AAD Group:" (Get-AADGroup -id $WEAssignment.target.GroupId).displayName " - Install Intent:" $WEAssignment.intent
    ...
    Write-Information " No Application Assignment"
