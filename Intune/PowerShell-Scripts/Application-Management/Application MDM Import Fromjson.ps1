...
$WEJSON_Data = Get-Content " $WEImportPath"
...
write-host
write-host " MDM Application '$WEDisplayName' Found..." -ForegroundColor Yellow
write-host
$WEJSON_Output
write-host
Write-WELog " MDM Application '$WEDisplayName'" " INFO" -ForegroundColor Yellow
