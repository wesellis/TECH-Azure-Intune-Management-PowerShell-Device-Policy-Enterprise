<#
.SYNOPSIS
    Application Mdm Import Fromjson
...
<#
.SYNOPSIS
    We Enhanced Application Mdm Import Fromjson
...
$WEJSON_Data = Get-Content -ErrorAction Stop " $WEImportPath"


$WEJSON_Convert = $WEJSON_Data | ConvertFrom-Json | Select-Object -Property * -ExcludeProperty id,createdDateTime,lastModifiedDateTime,version,'@odata.context',uploadState,packageId,appIdentifier,publishingState,usedLicenseCount,totalLicenseCount,productKey,licenseType,packageIdentityName
; 
$WEDisplayName = $WEJSON_Convert.displayName
; 
$WEJSON_Output = $WEJSON_Convert | ConvertTo-Json
            
Write-Information Write-Information " MDM Application '$WEDisplayName' Found..."
Write-Information $WEJSON_Output
Write-Information Write-WELog " MDM Application '$WEDisplayName'" " INFO"
Add-MDMApplication -JSON $WEJSON_Output
