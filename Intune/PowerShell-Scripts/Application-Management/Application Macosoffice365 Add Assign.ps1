<#
.SYNOPSIS
    Application Macosoffice365 Add Assign
...
<#
.SYNOPSIS
    We Enhanced Application Macosoffice365 Add Assign
...
Write-Information $WEAADGroup = Read-Host -Prompt " Enter the Azure AD Group name where applications will be assigned"
...
Write-WELog " Assigned '$WEAADGroup' to $($WECreate_Application.displayName)/$($WECreate_Application.id) with" " INFO" $WEAssign_Application.InstallIntent " install Intent"
