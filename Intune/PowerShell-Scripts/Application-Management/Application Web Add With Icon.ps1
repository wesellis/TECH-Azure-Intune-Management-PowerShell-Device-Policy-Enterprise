...
<#
.SYNOPSIS
    We Enhanced Application Web Add With Icon
...
.EXAMPLE
Add-WebApplication -JSON $WEJSON -IconURL pathtourl
...
write-host " Publishing" ($WEBing | ConvertFrom-Json).displayName -ForegroundColor Yellow
; 
$WECreate_Bing = Add-WebApplication -JSON $WEBing -IconURL " $iconUrl_Bing"

Write-WELog " Application created as $($WECreate_Bing.displayName)/$($create_Bing.id)" " INFO"
Write-Host
