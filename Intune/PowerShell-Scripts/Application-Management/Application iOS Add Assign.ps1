...
Write-Information Write-Warning " This script adds all your iOS Store Apps as 'available' assignments for the Azure AD group you specify."
...
Write-Information $culture = " EN-US"
