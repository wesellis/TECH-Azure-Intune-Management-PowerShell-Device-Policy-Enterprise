...
<#
.SYNOPSIS
    We Enhanced Get Intuneiosmanagedappassignment
        ...
        if ($WEManagedAppAssignments.id -ne $null) {
            ...
            foreach ($WEManagedAppAssignment in $WEManagedAppAssignments) {
               ...
               ;  $WEPSObject = [PSCustomObject]@{
                    AppName = $WEManagedApp.displayName
                    AppType = $WEManagedApp.'@odata.type'
                    AppID = $WEManagedApp.id
                    AssignmentID = $WEManagedAppAssignment.id
                    UninstallOnDeviceRemoval = $WEManagedAppAssignments.settings.uninstallOnDeviceRemoval
                }
