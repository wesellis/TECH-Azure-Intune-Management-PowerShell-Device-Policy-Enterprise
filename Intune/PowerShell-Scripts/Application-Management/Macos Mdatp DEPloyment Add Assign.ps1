...
<#
.SYNOPSIS
    We Enhanced Macos Mdatp Deployment Add Assign
...
do {
    ...
    if(!($WEAADGroup)){
        ...
        $WEAADGroup = Read-Host -Prompt " Enter the Azure AD Group name where apps and policies will be assigned"
...
$WEApplicationId = $WECreate_Application.id
