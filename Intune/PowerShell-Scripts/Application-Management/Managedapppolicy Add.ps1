...
<#
.SYNOPSIS
    We Enhanced Managedapppolicy Add
...
Write-Information write-host " Adding iOS Managed App Policy" -f Yellow

Add-ManagedAppPolicy -Json $iOS

Write-Information " Adding Android Managed App Policy" -f Yellow

Add-ManagedAppPolicy -Json $WEAndroid
