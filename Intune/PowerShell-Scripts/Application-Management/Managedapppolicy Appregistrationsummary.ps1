...
param(
    ...
    .NOTES
    NAME: Get-ManagedAppPolicyRegistrationSummary -ErrorAction Stop
    #>
...
param(
        ...
        try {
            ...
            if ($WEReportType -eq "" -or $null -eq $WEReportType) {
            ...
            elseif ($WEReportType -eq " Android_iOS" ) {
                ...
                if ($WENextPage -ne "" -and $null -ne $WENextPage) {
           ...
           ;  $responseBody = $reader.ReadToEnd();
            ...
            Write-Information $WEStoploop = $true
            break
        }
    }
...
function
    ...
    Write-Information $WEExportPath = Read-Host -Prompt " Please specify a path to export the policy data to e.g. C:\IntuneOutput"
    ...
    if($WEAppType -eq " Android_iOS" -or $WEAppType -eq " WIP_WE" -or $WEAppType -eq " WIP_MDM" ) {
        ...
        Write-Information write-host " Running query against Microsoft Graph to download App Protection Report for '$WEAppType'.." -f Yellow
        ...
        do {
            ...
            Write-Information " Your data is being downloaded for '$WEAppType'..."
