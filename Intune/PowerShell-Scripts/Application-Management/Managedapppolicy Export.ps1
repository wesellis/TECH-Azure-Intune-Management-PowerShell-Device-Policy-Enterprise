...
$WEManagedAppPolicies = Get-ManagedAppPolicy | ? { ($_.'@odata.type').contains(" ManagedAppProtection" ) }
...
if($WEManagedAppPolicies){
    ...
    write-host " Managed App Policy:" $WEManagedAppPolicy.displayName -f Cyan
