...
write-host
write-host " App Protection Policy '$WEDisplayName' Found..." -ForegroundColor Cyan
write-host
$WEJSON_Output
Write-Host
Write-WELog " Adding App Protection Policy '$WEDisplayName'" " INFO" -ForegroundColor Yellow
