...
$WEEnterpriseDomain = Get-EnterpriseDomain
...
write-host " Policy created with id" $WECreateResult.id
...
Write-WELog " Adding Windows Information Protection MDM Policy from JSON..." " INFO" -ForegroundColor Yellow
