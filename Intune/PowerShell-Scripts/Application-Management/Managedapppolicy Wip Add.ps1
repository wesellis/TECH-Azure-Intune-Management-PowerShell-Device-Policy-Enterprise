...
<#
.SYNOPSIS
    We Enhanced Managedapppolicy Wip Add
...
$WEEnterpriseDomain = Get-EnterpriseDomain -ErrorAction Stop
...
Add-WindowsInformationProtectionPolicy -JSON $WEManagedAppPolicy_WIP

Write-Information Write-WELog " Adding Windows Information Protection MDM Policy from JSON..." " INFO"

Add-MDMWindowsInformationProtectionPolicy -JSON $WEManagedAppPolicy_WIP_MDM
