...
.EXAMPLE
Get-ApplePushNotificationCertificate -ErrorAction Stop
Returns apple Push Notification Certificate configured in Intune
.NOTES
NAME: Get-ApplePushNotificationCertificate -ErrorAction Stop
...
$WEResource = " devicemanagement/applePushNotificationCertificate"
    ...
    $ex = $_.Exception
        ...
        Write-WELog " Resource Not Configured" " INFO" -ForegroundColor Red
...
; 
$WEAPNS = Get-ApplePushNotificationCertificate -ErrorAction Stop

$WEAPNS
; 
$WEDateTime = ([datetimeoffset]::Parse($WEAPNS.expirationDateTime)).DateTime.DateTime

Write-WELog " Expiration Date Time:" " INFO" $WEDateTime
