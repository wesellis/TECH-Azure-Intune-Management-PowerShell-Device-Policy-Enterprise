...
<#
.SYNOPSIS
    We Enhanced Certificateconnector Get
...
.EXAMPLE
Get-CertificateConnector -ErrorAction Stop
...
.NOTES
NAME: Get-CertificateConnector -ErrorAction Stop
...
$WEResource = " deviceManagement/ndesconnectors"
...
; 
$WECertificateConnectors = Get-CertificateConnector -ErrorAction Stop

if($WECertificateConnectors){

    foreach($WECStatus in $WECertificateConnectors){

        Write-Information " Certificate Connector:" $WECStatus.displayName -f Yellow
        Write-Information " ID:" $WECStatus.id
        Write-Information " Last Connection Date and Time:" $WECStatus.lastConnectionDateTime
        Write-Information " Status:" $WECStatus.state
        Write-Information }
    ...
    Write-WELog " No Certificate Connectors configured..." " INFO" -ForegroundColor Red
    Write-Information }
