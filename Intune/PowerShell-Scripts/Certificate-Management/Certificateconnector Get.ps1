...
; 
$WECertificateConnectors = Get-CertificateConnector

if($WECertificateConnectors){

    foreach($WECStatus in $WECertificateConnectors){

        write-host " Certificate Connector:" $WECStatus.displayName -f Yellow
        write-host " ID:" $WECStatus.id
        write-host " Last Connection Date and Time:" $WECStatus.lastConnectionDateTime
        write-host " Status:" $WECStatus.state
        Write-Host
