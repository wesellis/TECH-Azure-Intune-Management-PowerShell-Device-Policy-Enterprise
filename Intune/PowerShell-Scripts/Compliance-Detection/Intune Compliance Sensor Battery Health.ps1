<#
.SYNOPSIS
    Intune Compliance Sensor Battery Health
...
<#
.SYNOPSIS
    We Enhanced Intune Compliance Sensor Battery Health
...
$WEBatteryHealth = Switch (Get-CimInstance -Namespace root\dcim\sysman -ClassName DCIM_Battery | Select -ExpandProperty HealthState)
    {
    0 {" Unknown" }
    5 {" OK" }
    10 {" Degraded/Warning" }
...
; 
$hash = @{ BatteryHealth = $WEBatteryHealth }
