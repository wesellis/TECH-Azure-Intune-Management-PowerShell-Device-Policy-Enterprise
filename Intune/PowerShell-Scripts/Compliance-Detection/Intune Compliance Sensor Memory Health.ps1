...
<#
.SYNOPSIS
    We Enhanced Intune Compliance Sensor Memory Health
...
{
Write-WELog " There is failure with one of the RAMS" " INFO"

}
; 
$WEMemoryHealth = switch($errorcheck)
{
    0 {" Healthy" }
    1 {" Not Healthy" }
}
...
; 
$hash = @{ HealthStatus = $WEMemoryHealth }
