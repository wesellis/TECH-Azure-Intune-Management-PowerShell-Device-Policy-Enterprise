<#
.SYNOPSIS
    Intune Compliance Sensor Wmi Chassis Intrusion
...
<#
.SYNOPSIS
    We Enhanced Intune Compliance Sensor Wmi Chassis Intrusion
...
$WECheckChassisSetting = Get-CimInstance -Namespace root/dcim/sysman -ClassName DCIM_BIOSEnumeration -Filter " AttributeName like 'Chassis Intrusion'" | select -ExpandProperty CurrentValue; 
$WECheckIntrusion = Get-CimInstance -Namespace root/dcim/sysman -ClassName DCIM_BIOSEnumeration -Filter " AttributeName like 'Chassis Intrusion Status'" | select -ExpandProperty CurrentValue
...
; 
$hash = @{ IntrusionSetting = $WECheckChassisSetting; IntrusionStatus = $WECheckIntrusion }
