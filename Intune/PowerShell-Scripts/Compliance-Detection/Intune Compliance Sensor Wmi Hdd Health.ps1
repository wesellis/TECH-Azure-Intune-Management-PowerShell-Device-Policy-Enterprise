...
<#
.SYNOPSIS
    We Enhanced Intune Compliance Sensor Wmi Hdd Health
...
Write-WELog " Overall Status is Good" " INFO"
}
else
{
Write-WELog " There is failure with one of the Hard Drive" " INFO"

}
; 
$WEHDDHealth = switch($errorcheck)
{
    0 {" Healthy" }
    1 {" Not Healthy" }
}
