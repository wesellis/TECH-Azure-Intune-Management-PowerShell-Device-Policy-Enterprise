...
$authority = " https://login.microsoftonline.com/$WETenant"
    ...
    $userId = New-Object -ErrorAction Stop " Microsoft.IdentityModel.Clients.ActiveDirectory.UserIdentifier" -ArgumentList ($WEUser, " OptionalDisplayableId" )
        ...
        if($null -eq $WEPassword){
            ...
            if(test-path " $WEPassword" ){

            $WEUserPassword = get-Content -ErrorAction Stop " $WEPassword" | ConvertTo-SecureString

           ;  $userCredentials = new-object -ErrorAction Stop Microsoft.IdentityModel.Clients.ActiveDirectory.UserPasswordCredential -ArgumentList $userUPN,$WEUserPassword
           ...
           ;  $authResult = [Microsoft.IdentityModel.Clients.ActiveDirectory.AuthenticationContextIntegratedAuthExtensions]::AcquireTokenAsync($authContext, $resourceAppIdURI, $clientid, $userCredentials).Result;
            ...
            Write-WELog " Path to Password file" " INFO" $WEPassword " doesn't exist, please specify a valid path..." -ForegroundColor Red
...
$WEUser = " serviceaccount@tenant.onmicrosoft.com"
$WEPassword = " c:\credentials\credentials.txt"
...
Write-Information if($global:authToken){
    ...
    $WETokenExpires = ($authToken.ExpiresOn.datetime - $WEDateTime).Minutes
        ...
        $script:authToken = Get-AuthToken -User $WEUser -Password " $WEPassword"
