...
write-host
write-host " Company Portal Branding '$WEDisplayName' Found..." -ForegroundColor Yellow
write-host
$WEJSON_Output
write-host
Write-WELog " Setting Company Portal Branding '$WEDisplayName'" " INFO" -ForegroundColor Yellow
