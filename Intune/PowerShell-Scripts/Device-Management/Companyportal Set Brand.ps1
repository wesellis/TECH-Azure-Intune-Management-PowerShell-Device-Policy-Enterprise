...
<#
.SYNOPSIS
    We Enhanced Companyportal Set Brand
...
Write-Information Write-Information " Icon Path '$iconUrl' doesn't exist..."
Write-Information " Please specify a valid path to an icon..."
Write-Information break
...
Set-IntuneBrand -JSON $WEJSON_Logo
