...
<#
.SYNOPSIS
    We Enhanced Companyportal Set Default
...
$WEResource = " deviceManagement/intuneBrandingProfiles"
...
$graphApiVersion = " Beta"
$WEResource = " deviceManagement/intuneBrandingProfiles('$id')"
...
Set-IntuneBrand -id $id -JSON $WEJSON_Default
