...
Write-Information write-host " Assigning Device Restriction Policy to AAD Group '$WEAADGroup'" -f Cyan
...
Write-Information Write-WELog " Adding iOS Device Restriction Policy from JSON..." " INFO"
Write-Information ; 
