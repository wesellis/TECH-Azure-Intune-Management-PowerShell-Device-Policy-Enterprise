<#
.SYNOPSIS
    Deviceconfiguration Import Fromjson
...
<#
.SYNOPSIS
    We Enhanced Deviceconfiguration Import Fromjson
...
param ( [Parameter(Mandatory=$false)][String]$WEFileName )
...
Write-Verbose " Resource: $WEDCP_resource"
    ...
    try {
        ...
        Write-Information " No JSON specified, please specify valid JSON for the Device Configuration Policy..." -f Red
...
If (Test-Path -Path $WEFileName -Type Leaf) {
	$WEImportPath = $WEFileName
} Else {
...
Write-Information Write-Information " Device Configuration Policy '$WEDisplayName' Found..."
Write-Information $WEJSON_Output
Write-Information Write-WELog " Adding Device Configuration Policy '$WEDisplayName'" " INFO"
Add-DeviceConfigurationPolicy -JSON $WEJSON_Output
