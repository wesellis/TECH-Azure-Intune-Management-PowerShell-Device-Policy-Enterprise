...
write-host
write-host " Device Configuration Policy '$WEDisplayName' Found..." -ForegroundColor Yellow
write-host
$WEJSON_Output
write-host
Write-WELog " Adding Device Configuration Policy '$WEDisplayName'" " INFO" -ForegroundColor Yellow
