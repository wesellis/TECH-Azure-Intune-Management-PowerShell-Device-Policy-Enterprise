<#
.SYNOPSIS
    Deviceenrollmentrestrictions Get
...
<#
.SYNOPSIS
    We Enhanced Deviceenrollmentrestrictions Get
...
$WEDeviceEnrollmentConfigurations | Where-Object { ($_.id).contains(" DefaultPlatformRestrictions" ) }
