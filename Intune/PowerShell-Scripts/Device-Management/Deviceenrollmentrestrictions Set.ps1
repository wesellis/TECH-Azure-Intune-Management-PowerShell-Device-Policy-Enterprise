...
.EXAMPLE
Get-DeviceEnrollmentConfigurations -ErrorAction Stop
Returns Device Enrollment Configurations configured in Intune
.NOTES
NAME: Get-DeviceEnrollmentConfigurations -ErrorAction Stop
...
.NOTES
NAME: Set-DeviceEnrollmentConfiguration -ErrorAction Stop
...
$WEApp_resource = " deviceManagement/deviceEnrollmentConfigurations"
    ...
    try {
        ...
        Write-Information " No Device Enrollment Configuration ID was passed to the function, provide a Device Enrollment Configuration ID" -f Red
        break
...
; 
$WEDeviceEnrollmentConfigurations = Get-DeviceEnrollmentConfigurations -ErrorAction Stop
; 
