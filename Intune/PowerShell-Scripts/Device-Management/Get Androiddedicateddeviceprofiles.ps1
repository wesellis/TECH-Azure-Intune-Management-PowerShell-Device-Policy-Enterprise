<#
.SYNOPSIS
    Get Androiddedicateddeviceprofiles
...
<#
.SYNOPSIS
    We Enhanced Get Androiddedicateddeviceprofiles
...
Write-WELog " Corporate-owned dedicated device Profiles found..." " INFO" -ForegroundColor Green
