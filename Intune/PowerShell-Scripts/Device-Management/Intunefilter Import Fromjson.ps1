...
<#
.SYNOPSIS
    We Enhanced Intunefilter Import Fromjson
...
$WEJSON_Convert = $WEJSON_Data | ConvertFrom-Json | Select-Object -Property * -ExcludeProperty id,createdDateTime,lastModifiedDateTime,roleScopeTags
; 
$WEDisplayName = $WEJSON_Convert.displayName
; 
$WEJSON_Output = $WEJSON_Convert | ConvertTo-Json -Depth 5
            
Write-Information Write-Information " Intune Filter '$WEDisplayName' Found..."
Write-Information $WEJSON_Output
Write-Information Write-WELog " Adding Intune Filter '$WEDisplayName'" " INFO"
Add-IntuneFilter -JSON $WEJSON_Output
