...
<#
.SYNOPSIS
    We Enhanced Manageddeviceoverview Get
...
.EXAMPLE
Get-ManagedDeviceOverview -ErrorAction Stop
Returns Managed Device Overview configured in Intune
.NOTES
NAME: Get-ManagedDeviceOverview -ErrorAction Stop
...
$WEResource = " deviceManagement/managedDeviceOverview"
...
; 
$WEMDO = Get-ManagedDeviceOverview -ErrorAction Stop

Write-WELog " Managed Device Overview:" " INFO" -ForegroundColor Yellow

$WEMDO

Write-WELog " Device Operating System Summary:" " INFO" -ForegroundColor Cyan
Write-Information $WEMDO.deviceOperatingSystemSummary
