...
<#
.SYNOPSIS
    We Enhanced Manageddevices Get Paging
...
$WEResource = " deviceManagement/managedDevices"
    ...
    $WEDevicesResponse = (Invoke-RestMethod -Uri $uri -Headers $authToken -Method Get)

    $WEDevices = $WEDevicesResponse.value

    $WEDevicesNextLink = $WEDevicesResponse." @odata.nextLink"

        while ($null -ne $WEDevicesNextLink){

            $WEDevicesResponse = (Invoke-RestMethod -Uri $WEDevicesNextLink -Headers $authToken -Method Get)
            $WEDevicesNextLink = $WEDevicesResponse." @odata.nextLink"
            $WEDevices = $WEDevices + $WEDevicesResponse.value
...
if($WEManagedDevices){
    ...
    foreach($WEMD in $WEManagedDevices){

    Write-Information " Managed Device" $WEMD.deviceName " found..." -ForegroundColor Yellow
    Write-Information $WEMD
...
Write-Information Write-WELog " No Managed Devices found..." " INFO"
Write-Information }
