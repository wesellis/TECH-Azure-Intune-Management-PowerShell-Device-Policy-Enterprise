...
write-host
write-host " Settings Catalog Policy '$WEDisplayName' Found..." -ForegroundColor Yellow
write-host
$WEJSON_Output
write-host
Write-WELog " Adding Settings Catalog Policy '$WEDisplayName'" " INFO" -ForegroundColor Yellow
