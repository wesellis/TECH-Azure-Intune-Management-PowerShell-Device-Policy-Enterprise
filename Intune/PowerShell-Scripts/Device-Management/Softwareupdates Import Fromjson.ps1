...
write-host
write-host " Software Update Policy '$WEDisplayName' Found..." -ForegroundColor Yellow
write-host
$WEJSON_Output
write-host
Write-WELog " Adding Software Update Policy '$WEDisplayName'" " INFO" -ForegroundColor Yellow
