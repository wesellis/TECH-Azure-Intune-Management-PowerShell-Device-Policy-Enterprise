<#
.SYNOPSIS
    Softwareupdates Import Fromjson
...
<#
.SYNOPSIS
    We Enhanced Softwareupdates Import Fromjson
...
$WEJSON_Convert = $WEJSON_Data | ConvertFrom-Json | Select-Object -Property * -ExcludeProperty id,createdDateTime,lastModifiedDateTime,version,'groupAssignments@odata.context',groupAssignments,supportsScopeTags
; 
$WEDisplayName = $WEJSON_Convert.displayName
; 
$WEJSON_Output = $WEJSON_Convert | ConvertTo-Json
            
Write-Information Write-Information " Software Update Policy '$WEDisplayName' Found..."
Write-Information $WEJSON_Output
Write-Information Write-WELog " Adding Software Update Policy '$WEDisplayName'" " INFO"
