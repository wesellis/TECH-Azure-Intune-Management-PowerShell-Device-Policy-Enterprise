...
[CmdletBinding()]
function WE-Get-Win10IntuneManagedDevices -ErrorAction Stop {
...
This gets information on Intune managed devices
.EXAMPLE
Get-Win10IntuneManagedDevices -ErrorAction Stop
.NOTES
NAME: Get-Win10IntuneManagedDevices -ErrorAction Stop
