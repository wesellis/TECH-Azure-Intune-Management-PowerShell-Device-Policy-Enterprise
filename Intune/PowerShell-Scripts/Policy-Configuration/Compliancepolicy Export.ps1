...
<#
.SYNOPSIS
    We Enhanced Compliancepolicy Export
...
$WECPs = Get-DeviceCompliancePolicy -ErrorAction Stop
    ...
    Write-Information " Device Compliance Policy:" $WECP.displayName -f Yellow
    Export-JSONData -JSON $WECP -ExportPath " $WEExportPath"
    Write-Information }
