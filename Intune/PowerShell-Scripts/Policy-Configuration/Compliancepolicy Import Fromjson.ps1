<#
.SYNOPSIS
    Compliancepolicy Import Fromjson
...
<#
.SYNOPSIS
    We Enhanced Compliancepolicy Import Fromjson
...
$WEJSON_Convert = $WEJSON_Data | ConvertFrom-Json | Select-Object -Property * -ExcludeProperty id,createdDateTime,lastModifiedDateTime,version
...
$WEJSON_Output = $WEJSON_Output.trimend(" }" )
; 
$WEJSON_Output = $WEJSON_Output.TrimEnd() + " ," + " `r`n"

; 
$WEJSON_Output = $WEJSON_Output + $scheduledActionsForRule + " `r`n" + " }"
            
Write-Information Write-Information " Compliance Policy '$WEDisplayName' Found..."
Write-Information $WEJSON_Output
Write-Information Write-WELog " Adding Compliance Policy '$WEDisplayName'" " INFO"
Add-DeviceCompliancePolicy -JSON $WEJSON_Output
