...
<#
.SYNOPSIS
    We Enhanced Remoteactionaudit Get
...
.EXAMPLE
Get-RemoteActionAudit -ErrorAction Stop
Returns any device compliance policies configured in Intune
.NOTES
NAME: Get-RemoteActionAudit -ErrorAction Stop


[cmdletbinding()]

$graphApiVersion = " Beta"
$WEResource = " deviceManagement/remoteActionAudits"
